...
<script>
    ...
    function addRowTableFrete(nomeServico, imgLogo, deadline, valorServico) {
        return '<tr><td><p style="margin:5px 0 0 0;text-align:center"> ' + nomeServico + ' </p></td><td style="vertical-align: middle;text-align: center;">Entrega em ' + deadline + ' dia(s)<br/>' + formatter.format(valorServico) + ' </td></tr>';
    }
